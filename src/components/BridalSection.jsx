  ...
  return (
    <section className="bg-[#111] py-12 md:py-20 px-6 border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ── Gold italic heading ── */}
        <h2 className="font-cormorant italic text-gold text-3xl md:text-4xl lg:text-5xl font-semibold leading-snug mb-10 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start mb-10">
          ...
          {/* ── Left: Bridal Image ── */}
          <div className="w-full md:w-[45%] flex-shrink-0 rounded-lg overflow-hidden">
            <Image
              src="/assets/home.jpg"
          ...
          <div className="space-y-5 text-gray-300 text-sm leading-relaxed flex-1 text-center md:text-left">
            <p>
