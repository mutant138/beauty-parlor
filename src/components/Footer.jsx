...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#ffd468] text-black pt-12 pb-6 border-t border-black/10 font-poppins">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
        {/* Contact Info */}
        <div className="space-y-6">
          <h3 className="text-black font-bold text-xl mb-4 uppercase tracking-wider">Contact Info</h3>
          <p className="text-black text-sm leading-relaxed max-w-xs opacity-90">
            Feel Free To Contact Us And One Of Our Consultants Will Contact You
            Within One Business Days.
          </p>
          <div className="space-y-4">
            <a
              href="https://maps.google.com/?q=bus+stop,+4th+St,+Thiru+Nagar,+Madurai,+Tamil+Nadu+625006"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-start gap-3 hover:opacity-60 transition-opacity text-black group"
            >
              <svg
                className="w-5 h-5 text-black mt-1 shrink-0 group-hover:scale-110 transition-transform"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <a
              href="tel:+917558160331"
              className="flex items-center gap-3 hover:opacity-60 transition-opacity text-black group"
            >
              <svg
                className="w-5 h-5 text-black shrink-0 group-hover:scale-110 transition-transform"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <ul className="grid grid-cols-2 md:grid-cols-1 gap-2.5">
            {menuLinks.map((link) => (
              <li key={link.name}>
                <Link
                  href={link.href}
                  className="text-black hover:opacity-60 text-sm flex items-center gap-2 group transition-all"
                >
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-1 gap-2.5">
            {locations.map((loc) => (
              <li key={loc}>
        ...
        <div className="space-y-8 flex flex-col items-center md:items-start text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="https://www.instagram.com/yazhinimakeup.madurai"
                className="w-10 h-10 rounded-full border border-black/20 text-black flex items-center justify-center hover:bg-black hover:text-[#ffd468] transition-all group"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div className="w-full flex flex-col items-center md:items-start">
            <h3 className="text-black font-bold text-xl mb-4 uppercase tracking-wider">
              Location
            </h3>
            <div className="w-full h-32 bg-white/[0.08] rounded-lg border border-black/10 overflow-hidden shadow-sm">
              <iframe
                src="https://maps.google.com/maps?q=bus%20stop,%204th%20St,%20Thiru%20Nagar,%20Madurai,%20Tamil%20Nadu%20625006&t=&z=15&ie=UTF8&iwloc=&output=embed"
                className="w-full h-full border-0"
                style={{ filter: "invert(90%) hue-rotate(180deg)" }}
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Yazhini Makeup Artist Location Map"
              ></iframe>
            </div>
          </div>
        </div>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto px-6 mt-12 pt-6 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-black/70">
        <p>Copyright {new Date().getFullYear()} Yazhini Makeup Artist | All Rights Reserved</p>
        <a
          href="https://www.yazhinimadurai.com"
          className="hover:opacity-60 transition-opacity text-black font-semibold"
        >
          www.yazhinimadurai.com
        </a>
      </div>
    </footer>
  );
